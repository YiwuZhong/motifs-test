...
def train_batch(b):
    ...
    labels = result.od_obj_labels  # [#obj_box]
    scores = result.od_obj_dists  # [#obj_box, 151]
    # final box location
    bbox_targets = result.od_box_targets  # [#obj_box, 4], gt box
    box_deltas = result.od_box_deltas  # [#obj_box, 151, 4], delta
    roi_boxes = result.od_box_priors  # [#obj_box, 4], prior box

    # RPN
    rpn_scores = result.rpn_scores  # [#obj_box, 2], yes/no
    rpn_box_deltas = result.rpn_box_deltas  # [#obj_box, 4]
